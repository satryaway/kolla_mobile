...
public class ActivityUtils {
     ...
     */
    public static final void returnToLoginPage(@NonNull Activity fromActivity) {
        // NOTE: going to Login page means we clear access token
        LoginJson.Response.clearAccessToken(fromActivity);

        // we target Main, but don't return if already in Login page, because Main will start Login
        if (fromActivity instanceof IntroActivity)
            return;
    ...
    public static final void quickExit(@NonNull Activity activity) {

...
public class Convert {
    ...
    public static final int dpToPixel(Resources r, int dp) {
        // code is similar to TypedValue.applyDimension()
        return (int) (r.getDisplayMetrics().density * dp);
    }

    public static final int spToPixel(Resources r, int sp) {
        // code is similar to TypedValue.applyDimension()
     ...
     * <br />
     */
    public static final <T> T as(@NonNull Class<T> t, @Nullable Object o) {
     ...
     */
    public static final <T> T asEx(@NonNull Class<T> t, @Nullable Object o) {
        if (o == null)
     ...
     */
    private static final char[] base16Array = "0123456789abcdef".toCharArray();

    /**
     * Return Base16 (hexadecimal) String from bytes.
     */
    public static final String bytesToBase16String(byte[] bytes) {
     ...
     */
    public static final byte[] base16StringToBytes(String s) {
        int len = s.length();

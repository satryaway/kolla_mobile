...
public class ImageUtils {
    ...
    /**
     * Load image into ImageView, no scale down.
     */
    @Deprecated
...
//        ImageView imageView = Convert.as(ImageView.class, parent.findViewById(imageViewResId));
//        if (imageView != null)
//            loadImageNoScale(ctx, url, imageView);
    }

    /**
     * Load image into ImageView with place holder, no scale down.
     */
    @Deprecated
...
//        ImageView imageView = Convert.as(ImageView.class, parent.findViewById(imageViewResId));
//        if (imageView != null)
//            loadImageNoScale(ctx, url, imageView, placeHolderRes);
    }
...
//            return;
//        Glide.with(ctx).load(url).dontTransform().into(imageView);
//        Log.d("Image", url);
    }
...
//     * Load image into ImageView with place holder , no scale down.
//     */
//    public static final void loadImageNoScale(Context ctx, String url, ImageView imageView, int placeHolderRes) {
//        if (TextUtils.isEmpty(url))
//            return;
//        Glide.with(ctx).load(url).placeholder(placeHolderRes).dontTransform().into(imageView);
//        Log.d("Image", url);
//    }

...
public class StorageUtils {
    ...
    public static final File getOutputMediaDir() {
        ...
        File mediaStorageDir = new File(Environment.getExternalStoragePublicDirectory(
                Environment.DIRECTORY_PICTURES), BuildConfig.MEDIA_DIR);
    ...
    public static final String getImagePath(Context ctx, Uri uri) {
        ...
        cursor = ctx.getContentResolver().query(android.provider.MediaStore.Images.Media.EXTERNAL_CONTENT_URI, null,
